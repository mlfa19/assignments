...
\begin{exercise}
TODO: describe a random process and ask students to convert it into a probability space.
\end{exercise}
...
\begin{exercise}
TODO: Describe a random process that includes a random quantity.  Ask students to convert this to a random variable and a PMF.
\end{exercise}
...
\begin{exercise}
TODO: give things that are easy to compute using complement rule, but hard to compute directly.
\end{exercise}
