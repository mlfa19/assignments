...
You should be pretty proficient with the vanilla form of Bayes' rule.  There are a few variants that we'd like to point out.  There are on exercises to do here, just add these to your bag of tricks (you'll be leveraging them later in this assignment).
