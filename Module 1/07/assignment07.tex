...
\begin{externalresources}[(TBD minutes)]
...
Open up \href{https://cs.stanford.edu/people/karpathy/convnetjs/}{Convnet.js} and try it on either MNIST or CIFAR-10.  Watch the network train.  Interpret as much of what you see as possible.  If you don't understand something, ask about it on NB (Convnet.js on MNIST or Convnet.js on CIFAR-10)
\end{exercise}
