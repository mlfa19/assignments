...
Train / test split.  Use it on a real dataset.  Interpret the results.




\section{This is in class now Confounding Variables}

The topic of confounding variables is a crucial topic in statistics and machine learning.  A very nice, conceptual writeup of the topic is \href{https://statisticsbyjim.com/regression/confounding-variables-bias/}{Statistics By Jim Confounding Variable Bias}.  Read this document and answer the following questions.

\begin{exercise}
\bes
\item Something in the checking understanding space (e.g., predicting how omitting a variable would impact the weight estimated for another variable).
\item Something in the context and ethics space (fairly open-ended probably asking them to reflect on the potential impacts of this sort of bias).  If we wanted to be more directive we could provide ethically charged contexts to consider confounding variables.
\ees
\end{exercise}
